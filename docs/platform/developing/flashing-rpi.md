...
1. Download images from [Downloads](https://download.tizen.org/releases/milestone/TIZEN).
...
2.  Install the connectivity drivers for each board:
    -   **Raspberry Pi 3/4**
        1.  Download the plugin zip file from the **Raspberry Pi 3/4(7.0) Plugin** section at (http://developer.samsung.com/tizen/TizenDeviceFirmware.html){:target="_blank"} and follow the instructions.
